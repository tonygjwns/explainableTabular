% Figure 1 body — the decision cascade of the deployment-decay instrument (PAPER_DRAFT_V4 §3).
% Single source of the tikzpicture. Consumers:
%   - paper/main.tex          (\input inside a figure environment; loads tikz libs in preamble)
%   - fig1_cascade.tex        (standalone wrapper for a stand-alone vector PDF)
% Requires \usetikzlibrary{shapes.geometric,arrows.meta,positioning,fit} in the host preamble.
\begin{tikzpicture}[
  font=\small\sffamily,
